...
var Synth = function(context) { // simple synth
	...
	this.bassDrumEvent = function(startTime,freq1,freq2,duration) {
		...
		SinOsc.noteOff(startTime+duration);
	}
	...
	this.hihatEvent = function(startTime,freq1,duration,pan) {
		...
		ampNode.gain.setValueAtTime(10,startTime);
...
var hiHatTest = new HihatTest(-1);
var schedular = new Schedular(context,0.05,0.07,hiHatTest);
schedular.start();

var hiHatTest2 = new HihatTest(1);
